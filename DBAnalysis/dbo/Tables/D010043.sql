CREATE TABLE [dbo].[D010043] (
    [LBrCode]        INT        NOT NULL,
    [PrdAcctId]      CHAR (32)  NOT NULL,
    [SrNo]           SMALLINT   NOT NULL,
    [Flag]           CHAR (1)   NOT NULL,
    [DocBrCode]      INT        NOT NULL,
    [DocPrdAcctId]   CHAR (32)  NOT NULL,
    [Amount]         FLOAT (53) NOT NULL,
    [LemType]        TINYINT    NOT NULL,
    [RecStatus]      TINYINT    NOT NULL,
    [OpenDt]         DATETIME   NOT NULL,
    [CloseDt]        DATETIME   NOT NULL,

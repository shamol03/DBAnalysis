CREATE TABLE [dbo].[D030051] (
    [LBrCode]        INT        NOT NULL,
    [PrdAcctId]      CHAR (32)  NOT NULL,
    [EffFromDate]    DATETIME   NOT NULL,
    [TDPrdCd]        CHAR (8)   NOT NULL,
    [GuaranteeDep]   FLOAT (53) NOT NULL,
    [Amount]         FLOAT (53) NOT NULL,
    [TDAcctId]       CHAR (32)  NOT NULL,
    [LemSrNo]        SMALLINT   NOT NULL,
    ...
    [AcctExistsYN]   CHAR (1)   NOT NULL,
    [CommunityGrpID] INT        NOT NULL
);
